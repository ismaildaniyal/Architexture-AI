...
import os  # Ensure this is imported if you use os.path
...
SECRET_KEY = 'django-insecure-0_tqx$4+6ag=$3zzp6av%(uqkttc3$+uzn_%sp06+bkmi2b$v('
...
# CORS_ALLOWEDCORS_ALLOWED_ORIGINS = [
#     'http://localhost:3000',
#     'http://127.0.0.1:3000',
# ]
